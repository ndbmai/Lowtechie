...
- [x] **Chỉnh theo Mai (25/9)**: họp online (địa điểm là link / Zoom / Meet) không tính giờ di chuyển, chuỗi chỉ còn Chuẩn bị; bỏ mọi gợi ý deep work tự động; Book lịch từ việc chỉ chọn Lịch + Ngày + Từ–Đến; bot Lark nói tiếng Anh mặc định (chọn tiếng Việt theo từng group) và hiểu lệnh tiếng Anh ("add task", "assign … to Linh, due Wednesday", "summarize the last 2 days"); chống lỗi "phiên Lark hết hạn" khi nhiều màn tải lịch cùng lúc
